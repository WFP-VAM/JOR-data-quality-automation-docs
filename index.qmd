...
- [Validation Coverage](guides/VALIDATION_COVERAGE.html) - Implementation status

### Examples
Real-world examples showing complete implementations:

- [BCM Welcome Meals](examples/BCM_WELCOME_MEALS.html)
- [BCM Helpdesk](examples/adding_bcm_helpdesk.html)
- [BCM Post Office Validation](examples/adding_bcm_post_office_validation.html)
...
| Understand validation coverage | [Validation Coverage](guides/VALIDATION_COVERAGE.html) |
